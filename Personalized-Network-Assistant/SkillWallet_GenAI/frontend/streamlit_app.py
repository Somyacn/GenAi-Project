"""
streamlit_app.py — Streamlit Frontend for SkillWallet GenAI

Provides the user-facing web interface for the Personalized
Networking Assistant using Streamlit.
"""
